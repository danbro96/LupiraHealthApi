...
internal static class Db
{
    ...
    public static string? ActivityName(short? a) => a is null ? null : ((MotionActivity)a.Value).ToString();
    public static string? ProviderName(short? p) => p is null ? null : ((LocationProvider)p.Value).ToString();
}
